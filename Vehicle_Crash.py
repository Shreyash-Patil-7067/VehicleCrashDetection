...
def cvDrawBoxes(detections, img):
    ...
    #=================================================================            	
        ...
        for (id1, p1), (id2, p2) in combinations(centroid_dict.items(), 2): # Get all the combinations of close detections, #List of multiple items - id1 1, points 2, 1,3
            ...
            if distance < 100.0:						# Set our distance threshold - If they meet this condition then..
    	...
    	#=================================================================        
        if len(vehicle_red_zone_list)>=2:
            text = "Crash Detected"
            ...
            #    image_sms_car.send_sms_alert('crash_alert.jpg')
...
def YOLO():
    ...
    cap = cv2.VideoCapture("crash2.mp4")                                # Uncomment for Local Stored video detection - Set input video
    ...
    while True:                                                          # Load the input frame and write output frame.
        ...
        detections = darknet.detect_image(netMain,altNames, metaMain, darknet_image, thresh=0.25)    # Detection occurs at this line and return detections, for customize we can change
